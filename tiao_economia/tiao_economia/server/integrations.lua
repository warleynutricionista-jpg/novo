...
-- tenta obter player object via QBCore (export / global). Suporta QBCore v2 via GetCoreObject
local function tryGetQBCorePlayer(src)
  -- QBCore v2: exports['qb-core']:GetCoreObject()
  if exports and exports['qb-core'] and type(exports['qb-core'].GetCoreObject) == 'function' then
    ...
    if ok and core and core.Functions and core.Functions.GetPlayer then
      local ok2, p = pcall(core.Functions.GetPlayer, core, src)
      if ok2 and p then return p end
    end
  end
  -- exports style: exports['qb-core'].GetPlayer(src)
